<div class="row">
 ...
 ['model_key' => 'description', "type"=>"textarea" ,'model' => isset($row) ? $row : null, 'model_name' =>"Description"],
    ...
    @include('include.input_lang',$fields )
        ...
        <div class="col-md-6 form-group">
            <label class="col-form-label">Banquet</label>
            <input class="form-control" type="number" min="0" step="0" name="banquet" id="banquet"
                   value="{{$row['banquet']??0}}">

        </div>
        <div class="col-md-6 form-group">
            <label class="col-form-label">Classroom</label>
            <input class="form-control" type="number" min="0" step="0" name="classroom" id="classroom"
                   value="{{$row['classroom']??0}}">

        </div>
        <div class="col-md-6 form-group">
            <label class="col-form-label">Reception</label>
            <input class="form-control" type="number" min="0" step="0" name="reception" id="reception"
                   value="{{$row['reception']??0}}">
