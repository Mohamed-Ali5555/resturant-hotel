<div class="row">
    ...
    $fields = [
        ...
        ['model_key' => 'service_type', 'model' => isset($row) ? $row : null, 'model_name' =>"Service Type"],
        ['model_key' => 'dress_code', 'model' => isset($row) ? $row : null, 'model_name' =>"Dress Code"],
    ...
    @include('include.input_lang',$fields )
        <div class="col-md-6 form-group">
            ...
            <input class="form-control" type="time"  name="start_time" id="start_time" value="{{$row['start_time']??'0'}}">

        </div>
    <div class="col-md-6 form-group">
            <label class="col-form-label">End Time</label>
            <input class="form-control" type="time"  name="end_time" id="end_time" value="{{$row['end_time']??'0'}}">

        </div>
        <div class="col-md-6 form-group">
            <label class="col-form-label">Indoor</label>
            <input class="form-control" type="number" min="0" step="1" name="indoor" id="indoor" value="{{$row['indoor']??0}}">

        </div>
    <div class="col-md-6 form-group">
            <label class="col-form-label">Outdoor</label>
            <input class="form-control" type="number" min="0" step="1" name="outdoor" id="outdoor" value="{{$row['outdoor']??0}}">
...
<h2 >Hours</h2>
            ...
            @if(isset($append['times'])&&count($append['times'])>0)
                @foreach($append['times'] as $key=>$time)
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 form-group">
                                        ...
                                        <input  value="{{$time['title']??''}}"
                                               class="form-control" name="times[]"  placeholder="Title "  >
